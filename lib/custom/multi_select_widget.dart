// ignore_for_file: prefer_final_fields, overridden_fields, annotate_overrides, no_logic_in_create_state
...
class CustomMultiSelectField<V> extends StatelessWidget {
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: MultiSelectChipField(
            scroll: false,
            selectedChipColor: kPrimaryRed,
            chipColor: Get.isDarkMode ? Colors.white24 : Colors.black12,
            showHeader: false,
...
class _MultiSelectChipFieldView<V> extends StatefulWidget
  ...
  _MultiSelectChipFieldView.withState(
      _MultiSelectChipFieldView<V> field, FormFieldState<List<V>> this.state)
      : items = field.items,
        title = field.title,
