...
/// returns a list of nse stocks as stock model objects
List<StockModel> get nseStocks {
  List<StockModel> stocks = [];
  kListOfStocks.forEach((key, value) {
    stocks.add(StockModel(symbol: key, fullName: value));
  });
  return stocks;
}
...
var kListOfStocks = {
  ...
  'ANDREWYU': 'Andrew Yule & Company Limited',
  ...
  'DHANVARSHA': 'Dhanvarsha Finvest Limited',
  'DHARAMSI': 'The Dharamsi Morarji Chemical Company Limited',
  ...
  'KOVAI': 'Kovai Medical Center and Hospital Limited',
  ...
  'TEMBO-RE': 'Tembo Global Ind Ltd-RE',
  ...
  'WINPRO': 'WinPro Industries Limited',
